...
public class PromocaoServices {
	...
	public void savePromocao(Promocao promocao) {
		...
		System.out.println("Digite o ID do destino colocar a promoção: ");
		promocao.setIdDestino(sc.nextInt());
		System.out.println("Coloque o valor do desconto que será dado na promoção: ");
		...
		try {
			...
			System.out.println("Promoção cadastrada com sucesso, continue comprando.");
	...
	public void menu() {
		...
		do {
			...
			default:
				System.out.println("Tente de novo,pois sua opção é inválida, digite um numero de 0 a 4.");
				break;
			}
